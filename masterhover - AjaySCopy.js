...
var emtr = new Emitter();
        emtr.on('scan', function() {
          ...
          console.log('Saving image frames to drive...');
          console.log('Image frames saved!');
  ...
  switch (stringSplit[0])
  {
    ...
    console.log("made it");
      ...
      console.log('Saving images..');
           console.log('Image frames have been saved');
      function hvr(delay) {
        var self = mission;
        mission._steps.push(function(cb) {
          self._control.hover();
          ...
          //Condition to scan when hovering (How can we check to see if the "scan" command exists in array???
